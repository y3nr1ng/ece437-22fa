...
// Tool Versions: 
// Description: 
//  Control LED with an 8-bit control variable with host-side reset.
//
// Dependencies: 
// 
// Revision:
...
module lab2e2(
    ...
    always @(posedge clk) begin
        ...
        if (clkdiv_counter >= clkdiv) begin
            slow_clk <= ~slow_clk;
            clkdiv_counter <= 0;
        end
    end
    ...
    wire [31:0]  clkdiv_wire;
    
    // Write the clkdiv register
    okWireIn wire11 (   .okHE(okHE), 
                        .ep_addr(8'h01), 
                        .ep_dataout(clkdiv_wire) );
