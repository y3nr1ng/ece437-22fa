...
I2CControllerEndpoints = namedtuple(
...
class I2CController(BaseI2CController):
    """
    TBD
    ...
    def write_to(self, dev_addr: int, reg_addr: int, reg_value: Union[int, Iterable[int]]) -> None:
        """
        TB
